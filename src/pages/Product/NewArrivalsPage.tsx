...
const NewArrivalsPage: React.FC = () => {
  const newArrivals: Product[] = getNewArrivals(); // Get all new arrivals

  return (
    <>
      
      <div className="container mx-auto px-4 py-12 text-[#222222] bg-[#F8F8F8]">
        <h1 className="text-4xl font-bold text-center mb-8">All New In</h1>
        {newArrivals.length === 0 ? (
          <p className="text-center text-lg">No new arrivals at the moment.</p>
        ) : (
