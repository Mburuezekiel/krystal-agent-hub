...
export const ProductCard: React.FC<ProductCardProps> = ({ product, className = "" }) => {
  ...
  return (
    <Link
      ...
      className={`block bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden group ${className}`}
    >
        ...
        <CardContent className="p-0 h-full flex flex-col">
          ...
          <div className="p-3 flex-grow flex flex-col justify-between">
            ...
            <Button
              ...
              className="w-full bg-[#D81E05] hover:bg-[#A01A04] text-white"
              size="sm"
            >
              {isAddingToCart ? (
                <>
